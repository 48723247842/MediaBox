...
go mod init universalstatussubscriber
...
/usr/local/bin/goBuildAllPlatforms mediaboxUniversalStatusSubscriber
sudo cp ./bin/linux/amd64/mediaboxUniversalStatusSubscriber /usr/local/bin/